...
<head>
    ...
    <title>Facture assurance tpv</title>
</head>
<body style="border: solid 2px;">
    ...
    <div style="width: 70%;margin-left:15%;border:solid 2px;">
        ...
        <p style="text-transform: capitalize;text-align:center;text-transform:capitalize;">Pour la période allant du  {{ ucwords($assurance[0]->date_effet) }} au {{ ucwords($assurance[0]->date_echeance) }}</p>
       </div>
    <br><br><br>
