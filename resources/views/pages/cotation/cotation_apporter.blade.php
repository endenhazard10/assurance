            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body centrer-text">
                            <a href="{{route('cotation_apporter_automobile')}}" class=" text-decoration-none text-dark font-weight-bold">Automobile</a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body centrer-text">
                            <a href="{{route('cotation_apporter_voyage')}}" class=" text-decoration-none text-dark font-weight-bold">Voyage</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body centrer-text">
                            <a href="{{route('cotation_apporter_habitation')}}" class=" text-decoration-none text-dark font-weight-bold">Habitation</a>
                        </div>
                    </div>
                </div>
