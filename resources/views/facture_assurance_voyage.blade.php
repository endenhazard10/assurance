...
<head>
    ...
    <title>Facture assurance voyage</title>
</head>
    ...
    <table width="50%" style="ma" align="center">
        ...
        <tr>
            ...
            <td style="text-align: left; font-size:12px;">
                DATE EFFET {{ ucwords($assurance[0]->date_depart) }}
            </td>
        </tr>
        <tr>
            <td style="font-size: 12px;line-height: 1.5;">
            ...
            <td style="text-align: left; font-size:12px;">
                DATE ECHEANCE {{ ucwords($assurance[0]->date_retour) }}
            </td>
        </tr>
    </table>
    <br><br>
    <div style="width: 70%;margin-left:15%;border:solid 2px;">
        <p style="font-size: 15px;text-align:center;">Assurance Voyage</p>
        <p style="text-transform: capitalize;text-align:center;">Numéro :  {{ ucwords($assurance[0]->numero_client) }}
             Avenant : @if(1==2)  @else 0000000 @endif</p>
        <p style="text-transform: capitalize;text-align:center;">Pour la période allant du  {{ ucwords($assurance[0]->date_depart) }} au {{ ucwords($assurance[0]->date_retour) }}</p>
       </div>
    <br><br><br>
