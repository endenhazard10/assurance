<div>
    ...
    <div class="container" style="margin-top: 100px;margin-bottom:100px">
        <div class="row">    
            @if(session()->get('accepter_deux_roues')==false)          
            <div class="col-12 col-md-3 mb-3">
                <div class="card h-100">
                    <a href="{{route('proposition_contrat_assurance_deux_roues')}}">
                        <img src="{{asset('images/contrat.jpg')}}" class="card-img-top img-b" alt="...">
                    </a>
                    <div class="card-body centrer-text">
                        <a href="{{route('proposition_contrat_assurance_deux_roues')}}" class=" text-decoration-none text-dark font-weight-bold">Proposition de contrat</a>
                        <p class="card-text">
            ...
            <div class="col-12 col-md-3 mb-3">
                <div class="card h-100">
                    <a href="{{route('contrat_assurance_deux_roues')}}">
                        <img src="{{asset('images/contrat_fini.jpg')}}" class="card-img-top img-b" alt="...">
                    </a>
                    <div class="card-body centrer-text">
                        <a href="{{route('contrat_assurance_deux_roues')}}" class=" text-decoration-none text-dark font-weight-bold">Valider la proposition et Imprimer le contrat</a>
                        <p class="card-text"></p>
                    </div>
                </div>
            </div>
