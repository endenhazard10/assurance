        ...
        <div class="row">    
            ...
            <div class="col-12 col-md-3 mb-3">
                <div class="card h-100">
                    ...
                    <div class="card-body centrer-text">
                        <a href="{{route('proposition_contrat_assurance_tpv')}}" class=" text-decoration-none text-dark font-weight-bold">Proposition de contrat</a>
                        <p class="card-text">
            ...
            <div class="col-12 col-md-3 mb-3">
                <div class="card h-100">
                    ...
                    <div class="card-body centrer-text">
                        <a href="{{route('contrat_assurance_tpv')}}" class=" text-decoration-none text-dark font-weight-bold">Valider la proposition et Imprimer le contrat</a>
                        <p class="card-text"></p>
                    </div>
                </div>
            </div>
