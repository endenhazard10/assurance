...
<div class="row mb-5 mt-5">
    ...
    {{-- <h3 style="text-align: center;color:#00008F;font-weight:bold;text-transform:uppercase;">Assurances Voyages</h3> --}}
    <div class="container-fluid">
        <div class="row mb-2 d-flex justify-content-center" style="background-color: ; color: #336699;">
            <div class="col-sm-6">
                <h1 class="p-1 mb-2 bg-secondary text-white" style="box-shadow: 15px 15px 20px #646464;text-align: center;font-weight: bold !important;font-size:24px;text-transform: uppercase;">Assurances Voyage</h1>
            </div>
        </div>
    </div>
    <br>
            ...
            <table class="table table-bordered">
                <thead class="bg-primary"> 
                    <tr>
                        ...
                        <th style="font-size: 12px;min-width:200px;">Date de naissance</th>
                        <th style="font-size: 12px;min-width:200px;">Numero passeport</th>
                        <th style="font-size: 12px;min-width:200px;">Date de validité</th>
                        <th style="font-size: 12px;min-width:200px;">Destination</th>
                ...
                @foreach ($resultat as $event)
                    <tbody>
                        <tr>
                            ...
                            <td style="font-size: 12px;min-width:200px;">{{ $event->date_de_naissance }}</td>
                            <td style="font-size: 12px;min-width:200px;">{{ $event->numero_passport }}</td>
                            <td style="font-size: 12px;min-width:200px;">{{ $event->date_validite_passeport }}</td>
                            <td style="font-size: 12px;min-width:200px;">{{ $event->pays }}</td>
                            ...
                            <td><a class="btn btn-warning" href="{{ route('imprimer_contrat_voyage', ['id' => $event->numero_client]) }}"><i class="fas fa-print" style="width: 130px; color: #ffffff;"></i></a></td>
                        </tr>
                    </tbody>
                @endforeach
            </table>
