    ...
    <form method="POST" wire:submit.prevent="calcule">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" disabled id="field1" name="numero_client" min="0"
        ...
        @if ($currentStep == 2)
            <div class="step-one" style="width: 150%; margin-left:-22%;">
                <div class="card">
                    <div style="background-color: #ec008c !important" class="card-header bg-primary text-white">STEP 2/4 - Véhicule</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="field19" class="form-control" min="0"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="field23" class="form-control" min="0"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="field29" wire:model="thierce_complete" @if($valeur_neuve==0) disabled @endif>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="field30"
                                        wire:model="reduction_thierce_complete" @if($valeur_neuve==0) disabled @endif>
                                        <option value="0" selected>-- Non Choisi --</option>
                                        <option value="10" selected>10 %</option>
                                        <option value="15" selected>15 %</option>
                                        <option value="20" selected>20 %</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="field37" wire:model="incendie" @if($valeur_venale==0) disabled @endif>
                                        <option value="non" selected>Non choisi</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="field38" wire:model="reduction_incendie" @if($valeur_venale==0) disabled @endif>
                                        <option value="0" selected>-- Non Choisi --</option>
                                        <option value="10" selected>10 %</option>
                                        <option value="15" selected>15 %</option>
                                        <option value="20" selected>20 %</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="field39" wire:model="vol" @if($valeur_venale==0) disabled @endif>
                                        <option value="non" selected>Non Choisi</option>
                                        <option value="oui">Choisi</option>
                                    </select>
                                    <span class="text-danger">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="field40" wire:model="reduction_vol" @if($valeur_venale==0) disabled @endif>
                                        <option value="0" selected>-- Non Choisi --</option>
                                        <option value="10" selected>10 %</option>
                                        <option value="15" selected>15 %</option>
                                        <option value="20" selected>20 %</option>
