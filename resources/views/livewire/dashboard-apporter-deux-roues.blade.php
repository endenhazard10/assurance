...
<div class="row mb-5 mt-5">
    ...
    <div class="container-fluid">
        <div class="row mb-2 d-flex justify-content-center" style="background-color: ; color: #336699;">
            <div class="col-sm-6">
                <h1 class="p-1 mb-2 bg-secondary text-white" style="box-shadow: 15px 15px 20px #646464;text-align: center;font-weight: bold !important;font-size:24px;text-transform: uppercase;">Assurances Deux Roues</h1>
            </div>
        </div>
    </div>
    <br>
                ...
                @foreach ($resultat as $event)
                    <tbody>
                        <tr>
                            ...
                            <td><a class="btn btn-warning" href="{{ route('imprimer_contrat_deux_roues', ['id' => $event->numero_client]) }}"><i class="fas fa-print" style="width: 130px; color: #ffffff;"></i></a></td>
                        </tr>
                    </tbody>
                @endforeach
            </table>
