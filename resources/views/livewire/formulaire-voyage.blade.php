                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter le numero de Passeport" wire:model="numero_passeport">
                                <span class="text-danger">@error('numero_passeport'){{ $message }}@enderror</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Motif du voyage</label>
                                <input type="text" class="form-control" placeholder="Enter le motif du voyage" wire:model="motif">
                                <span class="text-danger">@error('motif'){{ $message }}@enderror</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="age" class="form-control" placeholder="Enter votre age" wire:model="age">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="date_validite" class="form-control" placeholder="Enter la date de validité du passeport" wire:model="date_validite">
                                <span class="text-danger">@error('date_validite'){{ $message }}@enderror</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="date" name="date_de_naissance" class="form-control" placeholder="Enter votre age" wire:model="date_de_naissance">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" wire:model="formule">
                                    ...
                                    <option value="afrique-europe-moyen orient">Afrique-Europe-Moyen Orient</option>
                                    <option value="monde entier">Monde entier</option>
                                </select>
                                <span class="text-danger">@error('formule'){{ $message }}@enderror</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control"  placeholder="Enter la date de depart" wire:model="date_depart" value="{{$date_depart}}">
                            <span class="text-danger">@error('date_depart'){{ $message }}@enderror</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">Date de retour</label>
                            <input type="date" class="form-control"  placeholder="Enter la date de retour" wire:model="date_retour" value="{{$date_retour}}">
                            <span class="text-danger">@error('date_retour'){{ $message }}@enderror</span>
                        </div>
                    </div>
                </div>
                <div class="row">
