                     ...
                     <div class="row">
                         <div class="col-md-6">
                             <div class="form-group">
                                 ...
                                 <input type="number" class="form-control" placeholder="Entrer le numero de la police" wire:model="numero_police">
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-6">
                             <div class="form-group">
                                 ...
                                 <select class="form-control" wire:model="reduction_thierce_collision" id="reduction_thierce_collision">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" wire:model="personne_transportees">
                                        ...
                                        <option value="6500" >Deces:1000000 Infirmite:1000000 Frais medicaux:125000</option>
