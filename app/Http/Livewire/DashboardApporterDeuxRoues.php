...
class DashboardApporterDeuxRoues extends Component
{
    public $mois;
    public $month;
    public $years;
    ...
    public function render()
    {
        ...
        ->where('niveau', "deux roues")->orderBy('updated_at', 'desc')->paginate($this->parPage);
        ...
        return view('livewire.dashboard-apporter-deux-roues',[
            'resultat' => $resultat,
