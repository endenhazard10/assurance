...
class DashboardApporterMrh extends Component
{
    public $mois;
    public $month;
    public $years;
    ...
    {
        $requete = DB::table('assurance_mrhs')->where('id_apporter',Auth::user()->id)
        ->where('prenom','like','%'.$this->query.'%')->whereMonth('created_at', $this->mois)->whereYear('created_at', $this->years)
        ->orderBy('updated_at', 'desc')->paginate($this->parPage);
        ...
        return view('livewire.dashboard-apporter-mrh', [
            'requete' => $requete,
