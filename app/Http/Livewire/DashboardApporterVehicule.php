...
class DashboardApporterVehicule extends Component
{
    public $mois;
    public $month;
    public $years;
    ...
    public function render()
    {
        ...
        ->where('niveau', "vehicule")->orderBy('updated_at', 'desc')->paginate($this->parPage);
        ...
        return view('livewire.dashboard-apporter-vehicule', [
            'resultat' => $resultat,
